...
# # #     available_labels = ["Folder", "File", "Dataset"]
# # #     target_label = st.selectbox("Select Target Node Label:", options=available_labels)
...
# # from models import initialize_neomodel_classes, generate_neomodel_map
# #
# # st.set_page_config(
# #     page_title="Science Data Toolkit",
# #     page_icon="🖥️",
...
# #         f"bolt://localhost:{st.session_state['bolt_port']}", auth=(st.session_state['username'], st.session_state['password']))
# #
...
# #         with st.spinner("Pushing to database..."):
# #             try:
# #                 # Generate Neomodel classes dynamically
# #                 property_map = {"to_seek": {target_label: {col: "String" for col in match_columns}}}
...
from pathlib import Path
from neo4j import GraphDatabase
from models import initialize_neomodel_classes, generate_neomodel_map, merge_nodes_with_existing
