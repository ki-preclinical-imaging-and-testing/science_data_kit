...
class OntologySource:
    """
    A simplified version of isatools.model.OntologySource that can be used
...
def get_isa_objects():
    ...
    try:
        ...
        from isatools.model import OntologySource as IsaOntologySource
        ...
        # If isatools is not available, return our compatibility versions
        # For now, only OntologyAnnotation and OntologySource are implemented
