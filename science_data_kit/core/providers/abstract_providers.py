...
class MessagingProvider(BaseProvider, ABC):
    ...
    including methods for connecting to message brokers, publishing messages,
    ...
    async def list_topics(self) -> List[Dict[str, Any]]:
        """
        List available topics in the messaging system.
    ...
    async def create_topic(self, topic_name: str, partitions: int = 1, 
        ...
        """
        Create a new topic in the messaging system.
    ...
    async def delete_topic(self, topic_name: str) -> bool:
        """
        Delete a topic from the messaging system.
    ...
    async def publish_dataframe(self, topic_name: str, df: pd.DataFrame, 
        ...
        """
        Publish a pandas DataFrame to a topic, with each row as a separate message.
    ...
    async def consume_messages(self, topic_name: str, group_id: str, 
        ...
        """
        Consume messages from a topic with a callback function.
    ...
    async def consume_to_dataframe(self, topic_name: str, group_id: str,
        ...
        """
        Consume messages from a topic and return as a pandas DataFrame.
