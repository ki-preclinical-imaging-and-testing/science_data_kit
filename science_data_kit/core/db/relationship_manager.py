...
class RelationshipManager:
    ...
    def update_relationship_properties(self, relationship_id: int, properties: Dict[str, Any],
    ...
    def find_path(self, start_node_id: int, end_node_id: int, relationship_types: Optional[List[str]] = None,
