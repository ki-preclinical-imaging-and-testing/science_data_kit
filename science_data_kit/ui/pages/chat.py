"""
Chat Page Module for Science Data Kit

This module provides the Chat page for the Science Data Kit application.
It allows users to chat with their data using retrieval-augmented generation.
"""
...
class ChatPage(BasePage):
    ...
    def __init__(self):
        ...
        super().__init__(title="Chat with your data", icon="💬")
    ...
    def render_sidebar(self):
        """Render the sidebar for the Chat page."""
                ...
                try:
                    ...
                    if manager.test_connection():
                        ...
                        try:
                            ...
                            st.session_state["cached_labels"] = labels
                        ...
                        if GRAPHRAG_AVAILABLE:
                            with st.spinner("Initializing GraphRAG..."):
                                st.session_state["graph_rag"] = self._initialize_graph_rag(
                                    uri,
                                    user,
                                    password,
    ...
    def render_content(self):
        """Render the main content for the Chat page."""
        ...
        if st.session_state["graph_rag"] is None:
            ...
            if st.session_state["neo4j_uri"] and st.session_state["neo4j_user"] and st.session_state["neo4j_password"]:
                with st.spinner("Initializing GraphRAG..."):
                    ...
                    st.info(f"Using retriever type: {retriever_type}")

    @st.cache_resource
    def _initialize_graph_rag(self, uri, user, password, llm_provider=None, llm_api_key=None, llm_model=None):
        """
        ...
        Returns:
            GraphRAG instance or None if initialization fails
        """
        try:
