...
class DatabaseAdapter:
    ...
    def connect(self, uri: str, user: str, password: str, database: Optional[str] = None, connection_name: Optional[str] = None) -> bool:
        """
        ...
        try:
            ...
            connection_successful = self.db_manager._connect(connection_name)
