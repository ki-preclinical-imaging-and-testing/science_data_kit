# Science Data Kit (SDK) Streamlit to Flask Migration Roadmap - Version 05
...
| 05 | 2025-09-07 | Implemented cBioPortal browser for ontology term management |
...
## Current Status
The Science Data Kit has already begun implementing a framework-agnostic architecture with both Streamlit and Flask adapters. The core business logic has been extracted into framework-independent classes, and a Flask application structure has been established. The high-priority pages (connect, dashboard, file browser, explore, plugin connect) have been implemented in Flask with full functionality. Two medium-priority features have been implemented: the About page and the cBioPortal browser.
...
| api/cbioportal/cancer-types | Get cancer types API | Implemented |
| api/cbioportal/tumor-types | Get tumor types API | Implemented |
| api/cbioportal/studies | Get studies API | Implemented |
| api/cbioportal/study/<study_id> | Get study data API | Implemented |
...
| api/cbioportal/add-term | Add term manually API | Implemented |
| api/cbioportal/clear-terms | Clear terms API | Implemented |
| api/cbioportal/terms | Get terms API | Implemented |
...
Significant progress has been made in implementing the high-priority pages (connect, dashboard, file browser, explore, plugin connect) with full functionality. Two medium-priority features have been implemented: the About page and the cBioPortal browser. The next steps are to implement the remaining medium-priority features and enhance the UI components with Flask-specific capabilities.
