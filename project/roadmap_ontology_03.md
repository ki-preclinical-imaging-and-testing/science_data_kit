# Science Data Kit (SDK) Ontology Integration Roadmap - Version 03
...
- Comprehensive testing is still needed
...
1. Create and Update Tests
   - Create tests for ontology integration
   - Update existing tests to remove isatools dependencies
   - Add integration tests for the OntologyImporter and OntologyBrowser classes
...
The next steps involve creating tests for the ontology integration features and enhancing the ontology visualization capabilities to provide a better user experience.
