# Science Data Kit (SDK) Phase 4 Roadmap - App Migration Sidequest (Version 07)
...
| Task | Priority | Status | Notes |
|------|----------|--------|-------|
| Migrate `app/utils/models.py` to `science_data_kit/core/models/app_models.py` | Medium | Completed | All model classes have been successfully migrated |
| Migrate `app/utils/sidebar.py` to `science_data_kit/ui/components/sidebar.py` | Medium | Completed | Refactored into a class-based component |
...
| Task | Priority | Status | Notes |
|------|----------|--------|-------|
| Remove duplicate code after successful migration | Medium | In Progress | Identifying and removing redundant code |
| Update import statements throughout the codebase | High | In Progress | Updating references to migrated components |
...
1. Continue cleanup tasks:
   - Remove duplicate code after successful migration
