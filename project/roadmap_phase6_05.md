# Science Data Kit (SDK) Phase 6 Roadmap - Version 05
...
| Task | Priority | Status | Notes |
|------|----------|--------|-------|
| Implement responsive design for mobile | Medium | To Do | Add responsive layout for mobile devices |
...
1. Implementing responsive design for mobile devices
2. Adding customizable user preferences
3. Adding accessibility features
4. Implementing theme customization
