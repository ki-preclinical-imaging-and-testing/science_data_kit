# Science Data Kit (SDK) Phase 4 Roadmap - Version 05
## Overview
...
2. Set up Sphinx documentation system (Task 3.1.1)
3. Implement query profiling (Task 4.1.1)
4. Implement streaming data processing (Task 4.2.1)
5. Break down large modules (Task 5.1.1)
