# Science Data Kit (SDK) Phase 6 Roadmap - Version 01
...
- ModelLoader for loading models from various formats (pickle, joblib, Keras, PyTorch)
...
- Convenience functions for common inference operations
- Example function to demonstrate how to use the inference utilities
