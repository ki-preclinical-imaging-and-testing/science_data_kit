# Science Data Kit (SDK) Phase 4 Roadmap - App Migration Sidequest (Version 02)
...
3. Migrate remaining utilities (file_organizer.py, jupyter_adapter.py, neodash_adapter.py)
...
## Conclusion
The App Migration Sidequest is making excellent progress, with the completion of Phase 1 tasks and significant progress in Phase 2. The migration of core UI pages, specialized pages, and essential utilities has been successful, and the project is now ready to focus on testing, documentation, and the migration of remaining utilities. By following this plan, the project will achieve a more maintainable and organized codebase, aligning with the overall goals of Phase 4 of the Science Data Kit roadmap.