# Science Data Kit (SDK) Phase 6 Roadmap - Version 09
...
Additionally, work will begin on the remaining Database Connectors tasks:
1. Implementing SPARQL endpoint connector
2. Adding Elasticsearch connector
3. Implementing Cassandra connector
