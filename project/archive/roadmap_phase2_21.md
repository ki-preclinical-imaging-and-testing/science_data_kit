# Science Data Kit (SDK) Phase 2 Roadmap - Version 21
...
| Task | Priority | Status | Notes |
|------|----------|--------|-------|
| Create comprehensive user guide | High | In Progress | Started creating a comprehensive user guide in docs/user_guide/ with an index and detailed guides for integration capabilities |
...
10. **Documentation Improvements**: Started creating a comprehensive user guide:
...
1. **Continue Documentation Work**:
   - Complete the comprehensive user guide with detailed information on all SDK components
