# Science Data Kit (SDK) Phase 3 Roadmap - Version 10
...
1. Begin work on integration with data analysis pipeline and reporting engine.
2. Start implementing user interface enhancements, including customizable user preferences and responsive design.
3. Begin work on additional data source connectors, starting with SQL database and RESTful API connectors.
