# Science Data Kit (SDK) Phase 6 Roadmap - Version 18
...
## Next Steps
The immediate next steps are to continue implementing the remaining Documentation Enhancements tasks:
1. Documenting testing strategy
2. Adding more examples and use cases
3. Creating video tutorials for complex workflows

Additionally, work will continue on the Visualization Enhancements tasks:
1. Adding support for custom visualization templates
2. Implementing dashboard widgets
