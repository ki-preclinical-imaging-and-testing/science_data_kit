# Science Data Kit (SDK) Phase 2 Roadmap - Version 14
...
The JavaScript client library implementation provides a flexible and user-friendly way to interact with the SDK API from web applications and Node.js applications. The library includes:
