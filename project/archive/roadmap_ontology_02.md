# Science Data Kit (SDK) Ontology Integration Roadmap - Version 02
...
### Phase 1: Documentation and Testing (Weeks 1-2)
...
The next steps involve updating documentation and tests to ensure the new functionality is well-documented and tested, as well as enhancing the ontology visualization capabilities to provide a better user experience.
