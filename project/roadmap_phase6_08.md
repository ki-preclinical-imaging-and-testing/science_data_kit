# Science Data Kit (SDK) Phase 6 Roadmap - Version 08
...
| Add customizable user preferences | Medium | Completed | Implemented comprehensive preferences system with theme, font size, and other customization options |
| Add accessibility features | Medium | Completed | Implemented accessibility tab with high contrast mode, screen reader optimizations, reduced motion, enhanced focus indicators, and increased text spacing |
...
## Next Steps
The immediate next steps are to continue implementing the Machine Learning Integration tasks:
...
Additionally, work will begin on the Database Connectors tasks:
1. Adding MongoDB connector
2. Implementing SPARQL endpoint connector
3. Adding Elasticsearch connector
4. Implementing Cassandra connector
