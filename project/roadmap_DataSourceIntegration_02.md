# Science Data Kit (SDK) Data Source Integration Roadmap - Version 02
...
The next phase of development will focus on creating a unified data source selector that allows users to choose between different data sources, followed by integration testing and documentation updates.
...
### Phase 4: Integration and Finalization (Week 6) - IN PROGRESS
...
Significant progress has been made on the Data Source Integration roadmap, with the completion of both the Dropbox and Google Sheets integrations. The provider registry pattern provides a solid foundation for adding additional data sources, and both integrations demonstrate the effectiveness of this approach.

The next phase will focus on creating a unified data source selector to provide a seamless experience for users, allowing them to easily switch between different data sources. Once this is complete, integration testing and documentation updates will ensure that the new features are well-tested and easy to use.
