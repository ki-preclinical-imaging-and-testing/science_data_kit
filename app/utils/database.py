...
def load_db_config():
    ...
    Priority order:
    1. .db_config_auto.yaml (automatically generated by the app)
    2. .db_config.yaml (user-defined hidden config)
    3. db_config.yaml (user-defined visible config)
    4. Default hardcoded values

    Returns:
        dict: Database configuration with keys: uri, user, password, database
    """
    config_files = ['.db_config.yaml']
    default_config = {
