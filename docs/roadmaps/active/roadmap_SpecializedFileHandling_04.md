# Science Data Kit (SDK) Specialized File Handling Roadmap - Version 04
...
| Task | Priority | Status | Notes |
|------|----------|--------|-------|
| Implement EXIF metadata extractor | High | In Progress | Extract metadata from JPEG, TIFF images |
| Create image preview generator | High | In Progress | Generate thumbnails and previews for images |
...
2. Begin implementation of Core Interpreters phase:
   - Complete the EXIF metadata extractor for image files
   - Complete the image preview generator
   - Start implementing PDF metadata extractor and preview generator
   - Begin work on NetCDF and HDF5 interpreters for scientific data files

3. Continue UI Integration:
