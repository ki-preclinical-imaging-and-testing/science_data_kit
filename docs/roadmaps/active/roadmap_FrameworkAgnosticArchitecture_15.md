# Science Data Kit (SDK) Framework-Agnostic Architecture Roadmap - Version 15
...
## Current Status
The Framework-Agnostic Architecture implementation has completed the search functionality, file compression/extraction functionality, and file sharing and collaboration features in Phase 7 (Advanced Features). The file sharing functionality allows users to share files with other users and set their permissions (view, edit, manage). The following tasks have been completed:
