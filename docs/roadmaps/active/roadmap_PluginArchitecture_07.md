# Science Data Kit (SDK) Plugin Architecture Roadmap - Version 07
...
3. **Connection Manager (In Progress)**
   ...
   - Next steps: Implement compatibility layer for existing code
...
12. **Unit Tests**: Implemented comprehensive unit tests for all plugin implementations that cover:
...
The next steps in Phase 2 include refactoring the remaining providers and implementing a compatibility layer for existing code.
...
The next step in Phase 3 is to implement a compatibility layer for existing code.
