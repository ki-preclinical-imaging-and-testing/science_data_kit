# Science Data Kit (SDK) Phase 6 Roadmap - Version 17
...
| Add customizable user preferences | Medium | Completed | Implemented preferences system with theme, font size, and other UI settings |
...
| Implement theme customization | Low | Completed | Added multiple theme options and custom color selection |
...
| Enhance dashboard visualization guidance | Medium | Completed | Added detailed guidance on when to use SDK dashboard vs. NeoDash with specific use cases |
| Create visualization templates | Medium | Completed | Created reusable templates for common visualization types including bar charts, line charts, scatter plots, pie charts, network graphs, heatmaps, box plots, and histograms |
| Add support for custom visualization templates | Low | To Do | Allow users to create and save their own templates |
| Implement dashboard widgets | Medium | To Do | Create reusable widgets for dashboard customization |
...
## Next Steps
The immediate next steps are to continue implementing the remaining API Connectors tasks:
1. Implementing WebSocket streaming
2. Adding MQTT connector

Additionally, work will continue on the Documentation Enhancements tasks:
1. Adding code examples for common tasks
2. Adding more examples and use cases
3. Creating video tutorials for complex workflows
...
The implementation of the Kafka and RabbitMQ connectors further expands the platform's data source capabilities, allowing users to connect to and interact with message brokers for streaming data processing and event-driven architectures. These connectors provide a unified interface for managing topics/exchanges, publishing messages, and consuming messages, making it easier for users to work with streaming data and integrate with event-driven systems.
