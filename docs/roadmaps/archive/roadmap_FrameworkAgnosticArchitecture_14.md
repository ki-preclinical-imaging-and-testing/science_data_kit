# Science Data Kit (SDK) Framework-Agnostic Architecture Roadmap - Version 14
...
## Current Status
The Framework-Agnostic Architecture implementation has completed the search functionality and file compression/extraction functionality in Phase 7 (Advanced Features). The file compression/extraction functionality allows users to compress multiple files into various archive formats (ZIP, TAR, TAR.GZ, etc.) and extract files from archives. The following tasks have been completed:
