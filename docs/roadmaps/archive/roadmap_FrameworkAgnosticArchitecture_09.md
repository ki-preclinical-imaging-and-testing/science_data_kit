# Science Data Kit (SDK) Framework-Agnostic Architecture Roadmap - Version 09
...
4. ⏳ Begin React exploration
   ...
   - ⏳ Create React adapter layer for core components
   - ⏳ Prototype key components (data visualization)
