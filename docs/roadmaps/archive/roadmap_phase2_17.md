# Science Data Kit (SDK) Phase 2 Roadmap - Version 17
...
| Develop data migration tools | Medium | In Progress | Creating tools to facilitate schema changes and data transformations |
...
2. **Start User Experience Improvements**:
