# Science Data Kit (SDK) Phase 4 Roadmap - Version 07
## Overview
...
| 08 | 2023-08-15 | Implemented query profiling (Task 4.1.1) |
...
1. Implement streaming data processing (Task 4.2.1)
2. Break down large modules (Task 5.1.1)
3. Implement unit tests for core modules (Task 2.1.1)
4. Create deprecation plan for legacy components (Task 1.3.2)
5. Optimize Neo4j queries with proper indexing (Task 4.1.2)
