# Science Data Kit (SDK) Plugin Architecture Roadmap - Version 06
...
2. **Plugin Standardization (In Progress)**
   ...
   - Next steps: Refactor remaining providers in `core/providers/storage/`
...
3. **Connection Manager (In Progress)**
   ...
   - Next steps: Create migration guide for existing connection code
...
8. **Plugin Documentation Template**: Created a comprehensive template for documenting plugins in `core/plugins/examples/plugin_documentation_template.md` that includes:
...
9. **Unit Tests**: Implemented comprehensive unit tests for the template plugin implementation, LocalStoragePlugin, DropboxPlugin, and Microsoft365Plugin that cover:
...
The next steps in Phase 2 include refactoring the remaining providers and documenting the migration process for existing code.
...
The next step in Phase 3 is to create a comprehensive migration guide for existing connection code.
