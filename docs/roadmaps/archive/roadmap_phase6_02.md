# Science Data Kit (SDK) Phase 6 Roadmap - Version 02
...
- Docker Compose configuration for workshop environments
...
1. Creating a realistic preclinical research dataset
2. Developing a data loading script
3. Creating dataset documentation
4. Creating a 30-minute challenge tutorial
